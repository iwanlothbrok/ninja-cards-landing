  ...
  const copy =
    locale === 'bg'
      ? {
          ...
          subline:
            'Shinobi е за присъствие. Samurai е за хора, които искат срещата да продължи с реален интерес, лийд и follow-up.',
          pricingNote: 'Пробваш Samurai 30 дни без риск и продължаваш само ако ти носи стойност.',
          ...
          shinobiDescription: 'Подходящ е, ако искаш дигитална визитка и лесно споделяне, но не ти трябват lead capture и analytics.',
          shinobiHighlights: shinobi.highlights.slice(0, 3),
          shinobiCta: 'Виж стартовия план',
          samuraiTitle: 'Samurai',
          samuraiTagline: 'Най-добрият избор за продажби, срещи и реален follow-up.',
          samuraiPrice: '€8.9',
          samuraiMeta: `на ${pricingT('month')}`,
          samuraiDescription:
            'Получаваш lead forms, analytics, branding и по-силен next step веднага след срещата.',
          samuraiHighlights: [
            '30 дни без риск',
            'Lead capture form',
            'Analytics и история на взаимодействията',
            'Branding с твое лого и цветове',
          ],
          samuraiSupport: 'Ако си готов да тестваш дали картата може да носи реални запитвания, това е правилният старт.',
          samuraiCta: 'Започни 30 дни безплатно',
          teamTitle: 'За екипи и компании',
          teamText:
            'Shogun остава опцията за по-големи екипи, фирмен branding и централно управление на картите.',
