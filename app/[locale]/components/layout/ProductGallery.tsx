...
export default function ProductGallery() {
  ...
  const productDetails =
    locale === 'bg'
      ? [
          'Premium NFC карта с QR fallback за всеки телефон.',
  ...
  return (
    <section className="relative bg-[#0a0d13] px-4 py-14 text-gray-200 sm:py-18">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        >
          <div className="relative w-full max-w-xl overflow-hidden rounded-[1.75rem] border border-white/10 bg-black/20 p-4">
        ...
        >
          ...
          <div className="grid gap-8 border-t border-white/10 pt-6 lg:grid-cols-[0.9fr,1.1fr]">
            <div>
